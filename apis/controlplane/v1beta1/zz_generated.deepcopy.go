...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MicroK8sControlPlaneMachineTemplate) DeepCopyInto(out *MicroK8sControlPlaneMachineTemplate) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.InfrastructureRef = in.InfrastructureRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MicroK8sControlPlaneMachineTemplate.
func (in *MicroK8sControlPlaneMachineTemplate) DeepCopy() *MicroK8sControlPlaneMachineTemplate {
	if in == nil {
		return nil
	}
	out := new(MicroK8sControlPlaneMachineTemplate)
	in.DeepCopyInto(out)
	return out
}
